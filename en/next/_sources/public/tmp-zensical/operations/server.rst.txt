...
Facts used in these operations: :ref:`facts:server.AuthorizedKeys`, :ref:`facts:files.Directory`, :ref:`facts:server.EtcHosts`, :ref:`facts:files.FileContents`, :ref:`facts:files.FindInFile`, :ref:`facts:server.Groups`, :ref:`facts:server.Home`, :ref:`facts:server.Hostname`, :ref:`facts:server.Kernel`, :ref:`facts:server.KernelModules`, :ref:`facts:files.Link`, :ref:`facts:server.Locales`, :ref:`facts:server.Mounts`, :ref:`facts:server.Os`, :ref:`facts:server.Sysctl`, :ref:`facts:server.Timezone`, :ref:`facts:server.Uptime`, :ref:`facts:server.Users`, :ref:`facts:server.Which`.

.. _operations:server.etc_hosts:

:code:`server.etc_hosts`
~~~~~~~~~~~~~~~~~~~~~~~~
...
.. code:: python
    ...
    server.group(group: 'str', present=True, system=False, gid: 'int | str | None' = None,
         **kwargs,
    )
...
.. code:: python
    ...
    server.hostname(hostname: 'str', hostname_file: 'str | None' = None,
         **kwargs,
    )
...
.. code:: python
    ...
    server.kill(pid: 'int', signal: 'str' = 'TERM',
         **kwargs,
    )
...
.. code:: python
    ...
    server.locale(locale: 'str', present=True,
         **kwargs,
    )
...
.. code:: python
    ...
    server.modprobe(module: 'str', present=True, force=False,
         **kwargs,
    )
...
.. code:: python
    ...
    server.packages(packages: 'str | list[str]', present=True,
         **kwargs,
    )
...
.. code:: python
    ...
    server.script_template(src: 'str', args=(), **data,
         **kwargs,
    )
...
.. code:: python
    ...
    server.security_limit(domain: 'str', limit_type: 'str', item: 'str', value: 'int',
         **kwargs,
    )
...
.. code:: python
    ...
    server.shell(commands: 'str | list[str]',
         **kwargs,
    )
