...
Facts used in these operations: :ref:`facts:files.Directory`, :ref:`facts:files.File`, :ref:`facts:git.GitBranch`, :ref:`facts:git.GitConfig`, :ref:`facts:git.GitLocalCommit`, :ref:`facts:git.GitRemoteBranchCommit`, :ref:`facts:git.GitTag`, :ref:`facts:git.GitTrackingBranch`.
